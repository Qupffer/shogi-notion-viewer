...
「無料で使える」と「ストレージおよび使用回数制限を気にしなくていい」を優先しているため、GitHub Pagesを使用しています。  
つまり、`kif/` に置いた棋譜は基本「見られてしまう」可能性があります。  
...
普段使用しないアカウントで、リポジトリ名を変えて使用すると、意図しない形で内容が広く共有されるのを避けやすくなります。
